...
function shouldBehaveLikeLinearBondingCurve([
  deployer,
  wallet,
  beneficiary,
  operator,
  ...
  it("requires a non-null ERC20 token", async function () {
    await expectRevert.unspecified(
      LinearBondingCurve.new(wallet, ZERO_ADDRESS, this.erc1363Token.address, {
        from: deployer,
      })
    );
  });
  ...
  it("requires a non-null wallet", async function () {
    await expectRevert.unspecified(
      LinearBondingCurve.new(
        ZERO_ADDRESS,
        this.erc20Token.address,
        this.erc1363Token.address,
        { from: deployer }
      )
    );
  });
  ...
  it("requires a non-null ERC1363 token", async function () {
    await expectRevert(
      LinearBondingCurve.new(wallet, this.erc20Token.address, ZERO_ADDRESS, {
        from: deployer,
      }),
  ...
  context("once deployed", async function () {
    beforeEach(async function () {
      this.LinearBondingCurve = await LinearBondingCurve.new(
        wallet,
        this.erc20Token.address,
        this.erc1363Token.address,
        {
    ...
    it("has wallet", async function () {
      expect(await this.LinearBondingCurve.wallet()).to.equal(wallet);
    });

    it("has token", async function () {
      expect(await this.LinearBondingCurve.token()).to.equal(
        this.erc20Token.address
      );
    });
    ...
    describe("accepting payments", function () {
      describe("via transferFromAndCall", function () {
        beforeEach(async function () {
          await this.erc1363Token.approve(operator, value, {
            from: beneficiary,
          });
        });

        const transferFromAndCallWithData = function (from, to, value, opts) {
          return this.erc1363Token.methods[
            "transferFromAndCall(address,address,uint256,bytes)"
          ](from, to, value, data, opts);
        };

        const transferFromAndCallWithoutData = function (
          from,
          to,
          value,
          opts
        ...
        describe("with data", function () {
          ...
          it("should log purchase", async function () {
            ...
            await expectEvent.inTransaction(
              ...
              "TokensPurchased",
              {
                ...
                beneficiary,
                value,
                amount: await this.LinearBondingCurve.getTokenAmount(value),
              }
            );
          });
          ...
          it("should assign tokens to sender", async function () {
            ...
            expect(
              await this.erc20Token.balanceOf(beneficiary)
            ).to.be.bignumber.equal(
              await this.LinearBondingCurve.getTokenAmount(value)
            );
          });

          it("should increase token raised", async function () {
            const pre = await this.LinearBondingCurve.tokenRaised();
            ...
            const post = await this.LinearBondingCurve.tokenRaised();
      ...
      describe("via transferAndCall", function () {
        ...
        const transferAndCallWithoutData = function (to, value, opts) {
          return this.erc1363Token.methods["transferAndCall(address,uint256)"](
            to,
            value,
            opts
          );
        ...
        describe("without data", function () {
          ...
          it("reverts on zero-valued payments", async function () {
            await expectRevert.unspecified(
              transferAndCallWithoutData.call(
                this,
                this.LinearBondingCurve.address,
                0,
                {
      ...
      describe("via approveAndCall", function () {
        const approveAndCallWithData = function (spender, value, opts) {
          ...
          ](spender, value, data, opts);
        };

        const approveAndCallWithoutData = function (spender, value, opts) {
          return this.erc1363Token.methods["approveAndCall(address,uint256)"](
            spender,
            value,
            opts
          );
        ...
        describe("with data", function () {
          it("should accept payments", async function () {
            await approveAndCallWithData.call(
              this,
              this.LinearBondingCurve.address,
              value,
              { from: beneficiary }
        ...
        describe("without data", function () {
          ...
          it("reverts on zero-valued payments", async function () {
            await expectRevert.unspecified(
              approveAndCallWithoutData.call(
                this,
                this.LinearBondingCurve.address,
                0,
                {
